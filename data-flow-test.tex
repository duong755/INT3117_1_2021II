...
\begin{enumerate}[label = (\arabic*),itemindent=1cm]
    \item 1--8, 9 (T), 10, 16 (T), 17, 19, 20, 21, 22, 23 (T), 24 % (1)
    \item 1--8, 9 (T), 10, 16 (T), 17, 19, 20, 21, 22, 23 (F) % (2)
    \item 1--8, 9 (T), 10, 16 (F), 18, 19, 20, 21, 22, 23 (T), 24 % (3)
    \item 1--8, 9 (T), 10, 16 (F), 18, 19, 20, 21, 22, 23 (F) % (4)
    \item 1--8, 9 (F), 11 (T), 12, 16 (T), 17, 19, 20, 21, 22, 23 (T), 24 % (5)
    \item 1--8, 9 (F), 11 (T), 12, 16 (T), 17, 19, 20, 21, 22, 23 (F) % (6)
    \item 1--8, 9 (F), 11 (T), 12, 16 (F), 18, 19, 20, 21, 22, 23 (T), 24 % (7)
    \item 1--8, 9 (F), 11 (T), 12, 16 (F), 18, 19, 20, 21, 22, 23 (F) % (8)
    \item 1--8, 9 (F), 11 (F), 13 (T), 14, 16 (T), 17, 19, 20, 21, 22, 23 (T), 24 % (9)
    \item 1--8, 9 (F), 11 (F), 13 (T), 14, 16 (T), 17, 19, 20, 21, 22, 23 (F) % (10)
    \item 1--8, 9 (F), 11 (F), 13 (T), 14, 16 (F), 18, 19, 20, 21, 22, 23 (T), 24 % (11)
    \item 1--8, 9 (F), 11 (F), 13 (T), 14, 16 (F), 18, 19, 20, 21, 22, 23 (F) % (12)
    \item 1--8, 9 (F), 11 (F), 13 (F), 15, 16 (T), 17, 19, 20, 21, 22, 23 (T), 24 % (13)
    \item 1--8, 9 (F), 11 (F), 13 (F), 15, 16 (T), 17, 19, 20, 21, 22, 23 (F) % (14)
    \item 1--8, 9 (F), 11 (F), 13 (F), 15, 16 (T), 18, 19, 20, 21, 22, 23 (T), 24 % (15)
    \item 1--8, 9 (F), 11 (F), 13 (F), 15, 16 (T), 18, 19, 20, 21, 22, 23 (F) % (16)
\end{enumerate}
